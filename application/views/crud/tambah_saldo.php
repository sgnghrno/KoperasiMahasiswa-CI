    ...
    <div class="breadcrumb-holder container-fluid">
    	<ul class="breadcrumb">
			...
			<li class="breadcrumb-item active">Tambah Data Tabungan</li>
    	</ul>
		</div>
    		...
    		<div class="card o-hidden border-0 shadow-lg my-5">
    			<div class="card-body p-0">
    				...
    				<div class="row">
    					<div class="col-sm-12">
    						<div class="p-3">
    							<form method="post" action="<?php echo base_url().'saldo/input'; ?>"
    								...
    								<div class="box-body">
    									...
    									<div class="form-group">
    										...
    										<div class="col-sm-9">
    											<input name="setoran" type="text" class="form-control"
    												placeholder="Masukkan Jumlah" id="setoran">
    										</div>
    									</div>
    								</div>
