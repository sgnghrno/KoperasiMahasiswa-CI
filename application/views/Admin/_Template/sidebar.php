...
<li class="nav-item active">
  <a class="nav-link" href="<?php echo base_url().'saldo/home'; ?>">
...
<!-- Nav Item - Charts -->
<li class="nav-item">
  <a class="nav-link" href="<?php echo base_url().'saldo/d_saldo'; ?>">
...
<!-- Nav Item - Tables -->
<li class="nav-item">
  <a class="nav-link" href="<?php echo base_url().'home/d_anggota'; ?>">
